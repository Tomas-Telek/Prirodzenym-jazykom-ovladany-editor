...
Tento projekt je webová stránka s JavaScriptovým editorom, ktorý umožňuje upravovať text pomocou prirodzeného jazyka. Umožňuje používateľom manipulovať s obsahom pomocou bežnej reči namiesto manuálneho prepisovania.
